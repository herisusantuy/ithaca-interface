...
import ChartMaxPainHeader from './ChartMaxPainHeader';
...
const ChartMaxPain = ({ data }: ChartDataType) => {
  ...
  return (
    <div>
      <ChartMaxPainHeader />
      <div className={styles.leftLabel}>Option Market Value</div>
      <ResponsiveContainer className={styles.container} width='100%' height={487}>
        ...
        >
          ...
          <XAxis dataKey='strike' tickLine={false} axisLine={false} style={{ fill: '#9D9DAA', fontSize: 12 }} dy={5}>
